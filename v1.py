...
def menu(my_name,my_id):
	...
	linex()
	_____manasss_____ = input(' CHOOSE : ')
	if _____manasss_____ in ['1']:
		MANAS_public()
	elif _____manasss_____ in ['2']:
		fileopt()
	elif _____manasss_____ in ['3','03']:
		passask()
		MANASresults()
	elif _____manasss_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____manasss_____ in ['5','05']:
		contact()
	elif _____manasss_____ in ['0']:
		passask()
...
def MANASresults():
    ok_file_path = '/sdcard/MANASv1/MANASv1-OK.txt'
    cp_file_path = '/sdcard/MANASv1/MANASv1-CP.txt'
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r {P}[MANAS-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
